...
pg.defaults.user     = process.env.POSTGRES_ENV_POSTGRES_USER;
pg.defaults.password = process.env.POSTGRES_ENV_POSTGRES_PASSWORD;
pg.defaults.host     = process.env.POSTGRES_PORT_5432_TCP_ADDR;
pg.defaults.port     = process.env.POSTGRES_PORT_5432_TCP_PORT;
pg.defaults.database = process.env.POSTGRES_ENV_BLAMMO_DB_NAME;
